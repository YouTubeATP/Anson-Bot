// Export a function here for it to be executable from chat.
...
export * as remindme from "./commands/remindMe";
export * as osulink from "./commands/osu/osuLink";
export * as osurecent from "./commands/osu/osuRecent";
